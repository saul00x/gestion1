...
import { Package, AlertTriangle, Search, Edit, Trash2 } from 'lucide-react';
import { productsService, suppliersService, storesService } from '../../services/api';
import { normalizeApiResponse } from '../../config/api';
import { Produit, Fournisseur, Magasin } from '../../types';
